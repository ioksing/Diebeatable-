...
function login() {
	admin_email = "admin@uw.edu"
	admin_pass = "admin"
	login_email = document.getElementById('login-email').value
	login_pass = document.getElementById('login-pass').value
	//if(admin_email == login_email && admin_pass == login_pass){
	if(login_email == admin_email && login_pass == admin_pass){
...
function show_result() {
	...
	setTimeout(function(){document.location.href = "result.html"},500);
